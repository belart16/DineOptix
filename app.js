...
const appData = {
  ...
  },
  {
    ...
    "topDishes": [
      {"name": "Борщ", "orders": 156, "change": "+12%", "category": "Первые блюда"},
      {"name": "Куриная котлета с пюре", "orders": 143, "change": "+8%", "category": "Вторые блюда"},
      {"name": "Салат Цезарь", "orders": 128, "change": "-3%", "category": "Салаты"},
      {"name": "Плов узбекский", "orders": 112, "change": "+15%", "category": "Вторые блюда"},
      {"name": "Компот из сухофруктов", "orders": 98, "change": "+5%", "category": "Напитки"}
    ]
  },
  "menu": {
